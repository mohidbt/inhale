...
| **2.0.3 — Python agents service + framework migration** | **NEXT** | [phases/phase-2.0.3-langchain.md](phases/phase-2.0.3-langchain.md) |
| 2.1 — AI Auto-Highlight | Pending | [phases/phase-2.1-auto-highlight.md](phases/phase-2.1-auto-highlight.md) |
